...
stack = tf.nn.rnn_cell.MultiRNNCell([cell] * 2, state_is_tuple=True)
outputs, state = tf.nn.dynamic_rnn(stack, inputs, dtype=tf.float32, swap_memory=True)
